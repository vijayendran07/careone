      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* Social Media Icons moved here (to the right, below Treatments & Support) */}
            <div className="space-y-2">
              <h5 className="text-teal-200 text-xs font-semibold uppercase tracking-wider">Connect With Us</h5>
              <div className="flex items-center gap-3">
                {/* Instagram */}
