...
function Footer({ settings }) {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#004d4d] via-[#003333] to-[#004d4d] text-white border-t border-teal-950/50">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-6 py-10">
...
We blend cutting-edge technology with expert dermatology to ensure you leave feeling rejuvenated and empowered. Founded in 2025, we've helped thousands achieve their aesthetic goals.Care One has been pioneering advanced dermatological treatments with a commitment to excellence, safety, and patient transformation. 
              </p> 
            </div>
            ...
            <div className="flex items-center gap-3 pl-1">
              ...
              <a href="https://www.instagram.com/care_one_clinic_?igsh=ZHN3aG44dTJlODlz" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram"
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#E1306C] flex items-center justify-center transition-all duration-200 hover:scale-110">
              ...
              <a href="https://www.facebook.com/careoneclinic" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook"
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#1877F2] flex items-center justify-center transition-all duration-200 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3.5 h-3.5">
              ...
              <a href="https://youtube.com/@careoneclinic?si=0u542LjjWWBbsJor" target="_blank" rel="noopener noreferrer" aria-label="Watch us on YouTube"
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#FF0000] flex items-center justify-center transition-all duration-200 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3.5 h-3.5">
              ...
              <a href="https://wa.me/918390656789" target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp"
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#25D366] flex items-center justify-center transition-all duration-200 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3.5 h-3.5">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/>
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.117 1.528 5.845L.057 23.428a.75.75 0 0 0 .916.916l5.638-1.474A11.953 11.953 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.891 0-3.659-.52-5.168-1.427l-.371-.22-3.847 1.006 1.028-3.742-.242-.389A9.947 9.947 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
                </svg>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-teal-100/70">
              ...
              <li><Link to="/treatments#skin-rejuvenation" className="hover:text-white transition">Advanced Aesthetics</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-teal-100/70">
              ...
              {/* Working Hours Row */}
              <div className="flex items-start gap-2.5">
                <span className="material-symbols-outlined text-base text-secondary mt-0.5">schedule</span>
                <span>
                  Every Day<br />9:30 AM – 9:00 PM
                </span>
              </div>
            </div>
          </div>
