...
function Footer({ settings }) {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#004d4d] via-[#003333] to-[#004d4d] text-white border-t border-teal-950/50">
      <div className="max-w-[1440px] mx-auto px-5 md:px-8 lg:px-10 py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 items-start">

          {/* Column 1 — Brand Box */}
          <div className="space-y-4 sm:col-span-2 lg:col-span-2">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 flex flex-col items-start gap-4 shadow-lg shadow-black/20 w-full lg:w-[calc(100%-40px)] h-auto">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4 text-[15px] text-teal-100/70">
              ...
              <div className="flex items-start gap-2.5">
                <span className="material-symbols-outlined text-base text-secondary mt-0.5 flex-shrink-0">schedule</span>
                <span>Every Day<br />9:30 AM – 9:00 PM</span>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-white/10 py-5 text-center px-4">
        <p className="text-xs sm:text-sm text-teal-100/50">© {new Date().getFullYear()} {clinicName} Clinical Excellence. All rights reserved.</p>
      </div>
    </footer>
  )
}
