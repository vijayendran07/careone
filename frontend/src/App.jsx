    ...
    <footer className="bg-gradient-to-br from-[#004d4d] via-[#003333] to-[#004d4d] text-white border-t border-teal-950/50">
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
          ...
          {/* Column 1 — Brand Box */}
          <div className="space-y-3">
            <div className="bg-[#003c3c]/40 border border-white/5 rounded-xl p-3 flex flex-row items-center gap-3.5 shadow-sm backdrop-blur-xs">
              <div className="bg-white rounded-lg p-1.5 flex-shrink-0">
                <img src="/footer-logo.jpg" alt={`${clinicName} - Skin Hair Laser Clinic`} className="h-9 w-auto object-contain" />
              </div>
              <p className="text-teal-100/75 text-[11px] leading-relaxed">
                Providing world-class clinical excellence in skin & hair care.
              </p>
            </div>
            {/* Social Media Icons */}
            <div className="flex items-center gap-2.5 pt-0.5 pl-0.5">
              {/* Instagram */}
              <a href="https://www.instagram.com/care_one_clinic_?igsh=ZHN3aG44dTJlODlz" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram"
                className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#E1306C] flex items-center justify-center transition-all duration-200 hover:scale-110">
              ...
              <a href="https://www.facebook.com/careoneclinic" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook"
                className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#1877F2] flex items-center justify-center transition-all duration-200 hover:scale-110">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@careoneclinic?si=0u542LjjWWBbsJor" target="_blank" rel="noopener noreferrer" aria-label="Watch us on YouTube"
                className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#FF0000] flex items-center justify-center transition-all duration-200 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
                  <path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/>
                </svg>
              </a>
              {/* WhatsApp */}
              <a href="https://wa.me/918390656789" target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp"
                className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#25D366] flex items-center justify-center transition-all duration-200 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/>
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.117 1.528 5.845L.057 23.428a.75.75 0 0 0 .916.916l5.638-1.474A11.953 11.953 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.891 0-3.659-.52-5.168-1.427l-.371-.22-3.847 1.006 1.028-3.742-.242-.389A9.947 9.947 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
                </svg>
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-teal-200 text-xs uppercase tracking-wider">Treatments</h4>
            <ul className="space-y-2 text-[12px] text-teal-100/70">
          ...
          {/* Column 3 — Support */}
          <div className="space-y-3">
            <h4 className="font-bold text-teal-200 text-xs uppercase tracking-wider">Support</h4>
            <ul className="space-y-2 text-[12px] text-teal-100/70">
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-teal-200 text-xs uppercase tracking-wider">Clinic Details</h4>
            <div className="space-y-2 text-[12px] text-teal-100/70">
              {/* Location Row */}
