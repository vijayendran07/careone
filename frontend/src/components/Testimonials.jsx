    ...
    <section className="py-10 md:py-14 bg-surface-container-low">
      <div className="max-w-5xl mx-auto px-4 md:px-8">
        <div className="text-center mb-8 md:mb-12">
          <span className="text-secondary font-semibold uppercase tracking-widest text-sm md:text-base">Testimonials</span>
          <h2 className="text-3xl md:text-4xl font-bold mt-2">Real results from real patients</h2>
        </div>
